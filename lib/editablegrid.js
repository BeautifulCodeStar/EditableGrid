...
function EditableGrid(name, config) { 
	...
	if (name) this.initializeGrid(name, config);
}
...
{
	console.log("EditCell:", rowIndex, columnIndex)
	...
	with (this) {
		...
		var kk = {}
					kk.editCell = function(rowIndex, columnIndex) {
						...
						rowInd = rowIndex + 1;
						// var element = document.querySelector('tr#first_table_' + rowInd + ' td.editablegrid-' + ids[columnIndex]).style.background = "#e7d12d78";
						...
						const getSecond = getJSON(url).then(res => {
							...
							const item = res;
								plc.push({ name: 'status', label: 'Status', datatype: "string" })
								plc.push({ name: 'status_name_0', label: 'Status_name_0', datatype: "string" })
								plc.push({ name: 'status_name_1', label: 'Status_name_1', datatype: "string" })
								plc.push({ name: 'cycle', label: 'cycle', Datatype: "string" })
								plc.push({ name: 'cycle_ranges', label: 'Cycle_ranges', datatype: "string" })
								plc.push({ name: 'counter_enabler', label: 'Counter_enabler', datatype: "string" })
								plc.push({ name: 'counter', label: 'Counter', datatype: "string" })
								plc.push({ name: 'cycle_name_0_1', label: 'Cycle_name_0_1', datatype: "string" })
								plc.push({ name: 'cycle_name_1_0', label: 'Cycle_name_1_0', datatype: "string" })
								plc.push({ name: 'runtime_enabler', label: 'Runtime_enabler', datatype: "string" })
								plc.push({ name: 'runtime', label: 'runtime', datatype: "string" })
								plc.push({ name: 'rate', label: 'Rate', datatype: "string" })
								plc.push({ name: 'rate_delived_unit', label: 'Rate_delived_unit', datatype: "string" })
								plc.push({ name: 'rate_constant', label: 'Rate_constant', datatype: "string" })
								plc.push({ name: 'mapping', label: 'Mapping', datatype: "string" })
								plc.push({ name: 'mapping_reference', label: 'Mapping_reference', datatype: "string" })
							...
							mathGrid = new EditableGrid("MathPLCTable", {
							...
							mathGrid.load({"metadata": plc, "data": data});
							mathGrid.renderGrid("math", "math");
						})
					}
		kk.editCell(rowIndex, columnIndex)
	}
};
